...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="🤔𝑯𝑶𝑾 𝑻𝑶 𝑫𝑶𝑾𝑵𝑳𝑶𝑨𝑫❓", url='https://t.me/SixFlix/348')
        ]
    )
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('<i><b><u>⚠️ Repot </i></b></u>\n\n🤔ɪ ᴛʜɪɴᴋ ᴛʜɪs sᴇʀɪᴇs ɴᴏᴛ ʏᴇᴛ ʀᴇʟᴇᴀsᴇᴅ ᴏʀ ɴᴏᴛ ᴀᴅᴅᴇᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ ..!🤷 \nᴍᴀʏʙᴇ ɪғ ʏᴏᴜ ɴᴇᴇᴅ ᴀ ᴍᴏᴠɪᴇ. ᴀsᴋ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ..!\n<i><b>@Freakers_Filmy</i></b></a>\n\nഈ സിരീസ് OTT റിലീസ് ആവാത്തതൊ/ എൻ്റെ കളക്ഷനിൽ ഉൾപ്പെടുത്താതൊ ആവാം\nനിങ്ങൾ ചോദിച്ചത് ഒരു സിനിമ ആണെങ്കിൽ <i><b>@Freakers_Filmy</i></b>')
